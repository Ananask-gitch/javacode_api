...
func HandlerHello(w http.ResponseWriter) {
	results := "hello"
...
func (h handler) HandlerGetBalance(w http.ResponseWriter, r *http.Request) {
...
func (h handler) HandlerUpdateBalance(w http.ResponseWriter, r *http.Request) {
